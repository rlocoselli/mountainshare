...
public partial class ChangePasswordPage : ContentPage
{
    ...
    private bool isPasswordHiddenCurent = true;

    private void OnTogglePasswordVisibilityCurrent(object sender, EventArgs e)
    {
        isPasswordHiddenCurent = !isPasswordHiddenCurent;
        CurrentPasswordEntry.IsPassword = isPasswordHiddenCurent;
